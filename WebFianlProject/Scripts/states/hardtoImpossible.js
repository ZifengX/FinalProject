...
var states;
(function (states) {
    function hardtoImpossibleState() {
        univers2.update();
        coin.update();
        plane.update();
        //One Enemy
    ...
    states.hardtoImpossibleState = hardtoImpossibleState;
    ...
    states.hardtoImpossible = hardtoImpossible;
})(states || (states = {}));
//# sourceMappingURL=hardtoImpossible.js.map